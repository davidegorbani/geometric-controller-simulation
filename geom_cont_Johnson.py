...
fig4 = plt.figure()
plt.plot(t, roll, label='sim')
plt.plot(t, roll_d, label='ref')
plt.grid()
...
fig5 = plt.figure()
plt.plot(t, pitch, label='sim')
plt.plot(t, pitch_d, label='ref')
plt.grid()
...
fig5 = plt.figure()
plt.plot(t, yaw, label='sim')
plt.plot(t, yaw_d, label='ref')
plt.grid()
